(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function formatTime(totalMinutes) {
      ...
      var m = abs % 60;
      var prefix = negative ? '-' : '';
      return prefix + h + ' hours ' + m + ' minutes';
    }
    ...
    document.getElementById('calc-time-btn').addEventListener('click', function () {
      ...
      document.getElementById('calc-result-minutes').textContent = result + ' minutes';
    ...
    document.getElementById('convert-btn').addEventListener('click', function () {
      ...
      if (dir === 'to-minutes') {
        ...
        var total = h * 60 + m;
        resultValue.textContent = total + ' minutes';
      } else {
    ...
    document.getElementById('wage-btn').addEventListener('click', function () {
      ...
      if (dir === 'to-pay') {
        ...
        resultLabel.textContent = 'Total Pay';
        resultValue.textContent = '$' + pay.toLocaleString();
      } else {
        ...
        if (!totalPay || totalPay < 1) {
          alert('Please enter the total pay correctly.');
          return;
        }
        if (rH === 0 && rM === 0) {
          alert('Please enter the work hours.');
        ...
        resultLabel.textContent = 'Hourly Rate';
        resultValue.textContent = '$' + hourlyRate.toLocaleString();
      }
