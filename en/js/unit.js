document.addEventListener('DOMContentLoaded', function () {
  ...
  var units = {
    length: {
      ...
      items: [
        ...
        { key: 'inch', label: 'Inch (in)', factor: 0.0254 },
        { key: 'feet', label: 'Foot (ft)', factor: 0.3048 },
        { key: 'mile', label: 'Mile (mi)', factor: 1609.344 }
      ],
    ...
    weight: {
      ...
      base: 'g',
      items: [
        { key: 'mg', label: 'Milligram (mg)', factor: 0.001 },
        { key: 'g', label: 'Gram (g)', factor: 1 },
        { key: 'kg', label: 'Kilogram (kg)', factor: 1000 },
        { key: 't', label: 'Metric ton (t)', factor: 1000000 },
        { key: 'oz', label: 'Ounce (oz)', factor: 28.3495 },
        { key: 'lb', label: 'Pound (lb)', factor: 453.592 }
      ],
      sampleValues: [1, 10, 100, 500, 1000]
    },
    temperature: {
    ...
    area: {
      ...
      base: 'm2',
      items: [
        { key: 'mm2', label: 'Square millimeter (mm\u00B2)', factor: 0.000001 },
        ...
        { key: 'a', label: 'Are (a)', factor: 100 },
        { key: 'tsubo', label: 'Tsubo (Japanese)', factor: 3.30579 },
        { key: 'jo', label: 'Jo (tatami mat)', factor: 1.6562 }
      ],
  ...
  function getUnitShortLabel(key) {
    var map = {
      ...
      'inch': 'in', 'feet': 'ft', 'mile': 'mi',
      'mg': 'mg', 'g': 'g', 'kg': 'kg', 't': 't',
      'oz': 'oz', 'lb': 'lb',
      'C': '\u2103', 'F': '\u2109', 'K': 'K',
      'mm2': 'mm\u00B2', 'cm2': 'cm\u00B2', 'm2': 'm\u00B2', 'km2': 'km\u00B2',
      'ha': 'ha', 'a': 'a', 'tsubo': 'tsubo', 'jo': 'jo'
    };
    return map[key] || key;
  }
